...
public class juegodelgato {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if(check_draw(board)){
                show_board(board);
                System.out.println("Empate prros");
                System.exit(0);
            }
            check_win(board);
    ...
    public static void take_chance(String[] board, String player){
        ...
        System.out.println("dijite un numero del 1 al 9");
    ...
    public static void check_win(String[] board){
        ...
        for(String piece:pieces){
            ...
            if (board[0] == piece && board[4] == piece && board[8] == piece){
                ...
                show_board(board);
                System.out.println(piece+"ganaste :O");
                System.exit(0);
            }
